...
INVENTORY_BRINGUP: list[tuple[str, bytes, float]] = [
    ...
    ("ANT_PORT_DWELL = 0", bytes([0xA7, 0xB3, 0x0A, 0xC2, 0x82, 0x37, 0x00, 0x00, 0x80, 0x02, 0x70, 0x01, 0x05, 0x07, 0x00, 0x00, 0x00, 0x00]), 0.15),
    ("ANT_PORT_POWER = 30 dBm", bytes([0xA7, 0xB3, 0x0A, 0xC2, 0x82, 0x37, 0x00, 0x00, 0x80, 0x02, 0x70, 0x01, 0x06, 0x07, 0x2C, 0x01, 0x00, 0x00]), 0.15),
    ("QUERY_CFG = 0x0180", bytes([0xA7, 0xB3, 0x0A, 0xC2, 0x82, 0x37, 0x00, 0x00, 0x80, 0x02, 0x70, 0x01, 0x00, 0x09, 0x80, 0x01, 0x00, 0x00]), 0.15),
    ("INV_SEL = FIXED_Q", bytes([0xA7, 0xB3, 0x0A, 0xC2, 0x82, 0x37, 0x00, 0x00, 0x80, 0x02, 0x70, 0x01, 0x02, 0x09, 0x00, 0x00, 0x00, 0x00]), 0.15),
    ("INV_ALG_PARM_0 = 0", bytes([0xA7, 0xB3, 0x0A, 0xC2, 0x82, 0x37, 0x00, 0x00, 0x80, 0x02, 0x70, 0x01, 0x03, 0x09, 0x00, 0x00, 0x00, 0x00]), 0.15),
    ("INV_ALG_PARM_2 = 0", bytes([0xA7, 0xB3, 0x0A, 0xC2, 0x82, 0x37, 0x00, 0x00, 0x80, 0x02, 0x70, 0x01, 0x05, 0x09, 0x00, 0x00, 0x00, 0x00]), 0.15),
...
def is_inventory_tag(d: bytes) -> bool:
    return len(d) >= 10 and d[8] == 0x81 and d[9] == 0x00
